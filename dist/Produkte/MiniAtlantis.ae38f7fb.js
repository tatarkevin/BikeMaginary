/* Klassennamen */ const headerbar_name = "Headerbar";
...
/* Ab hier nichts mehr ändern, sonst ist alles kaputt :D */ var menu_is_active = false;
...
function toggle_menu(button) {
    ...
    if (menu_is_active) click_locker.style.display = "block";
    else click_locker.style.display = "none";
    for (let child of button.children)child.classList.toggle(icon_hidden_name);
...
window.onresize = function() {
    if (menu_is_active && window.innerWidth > headerbar_breakpoint) toggle_menu(menu_button);
};

//# sourceMappingURL=MiniAtlantis.ae38f7fb.js.map
